...
public class mydb
{
    ...
    public mydb()
    {
        try
        {
            con = @"Data Source=DESKTOP-8TVC6LE;Initial Catalog=order_tracking_latest;Persist Security Info=True;User ID=sa;Password=2020";               
    ...
    public void edit_grid(GridView gv)
    {
