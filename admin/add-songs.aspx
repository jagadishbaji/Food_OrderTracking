<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add-songs.aspx.cs" Inherits="admin_add_songs" %>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>Manage Songs
                        ...
                        <small>Add songs to play at Hotel</small>
                    </h1>
                    <ol class="breadcrumb">
                        ...
                        <div class="col-lg-4">
                            <div class="box box-info">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Add Songs</h3>
                                </div>
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:FileUpload ID="fu_songs" CssClass="form-control btn-file" runat="server" />
                                    </div>
                    ...
                    <div class="col-lg-12">
                            <table class="table table-bordered table-hover">
                                ...
                                <asp:Repeater ID="rpt_items" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td><%# Eval("song_name") %></td>                                            
                                            <td align="center">
                                                <asp:LinkButton ID="lnk_delete" OnClientClick="return confirm('Are you sure to delete this file?')" OnClick="lnk_delete_Click" CommandArgument='<%# Eval("song_id") %>' CssClass="btn btn-danger" runat="server"> <i class="fa fa-trash-o"></i> </asp:LinkButton></td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
                            </table>
