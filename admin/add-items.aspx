<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add-items.aspx.cs" Inherits="admin_add_items" %>
     ...
     <uc1:header runat="server" ID="header" />
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>Manage Items
                        ...
                        <small>Add items for menu</small>
                    </h1>
                    <ol class="breadcrumb">
                        ...
                        <div class="col-lg-4">
                            <div class="box box-info">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label>Qty</label>
                                        <asp:TextBox ID="txt_qty" CssClass="form-control" placeholder="Qty" runat="server"></asp:TextBox>
                                    </div>                               
                                    <div class="form-group">
                                        <label>Picture</label>
                                ...
                                <asp:Repeater ID="rpt_items" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td align="center">
                                                <asp:CheckBox ID="CheckBox1" runat="server" Checked='<%# Boolean.Parse(Eval("is_active").ToString()) %>' OnCheckedChanged="CheckBox1_CheckedChanged" AutoPostBack="true" AccessKey='<%# Eval("item_id") %>' /></td>
                                            <td><a href="#" class="btn btn-flat show-picture" data-url='<%# Eval("item_image") %>'>View picture</a></td>

                                            <td align="center">
                                                <asp:LinkButton ID="lnk_delete" OnClientClick="return confirm('Are you sure to delete this file?')" OnClick="lnk_delete_Click" CommandArgument='<%# Eval("item_id") %>' CssClass="btn btn-danger" runat="server"> <i class="fa fa-trash-o"></i> </asp:LinkButton></td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
                            </table>
        ...
        <script>
            ...
            $(".show-picture").click(function (e) {
                $("#combo_image").attr("src", "../project_files/items/" + $(this).data("url"));
